...
export const COMMANDS: CommandMeta[] = [
  ...
  },
  {
    ...
    requiresProject: true,
    features: [
      'memory|learnings [topic] — recall project memory (BM25 + semantic + recall)',
      'tiers — context cache tiers L0–L3 contract + live L0 budget',
      'project — verified per-project facts preview (stack + real commands)',
      'artifacts — safe artifact repo (judgment, ships, handoffs, checkpoints)',
      'skills — refreshed skill catalog index',
      '--md prints the tool markdown rendering; --json forces the JSON envelope',
    ],
  },
  {
    name: 'search',
  ...
  },
  {
    ...
    params: '[--force|-f] [--backup|-b] [--dry-run|-n] [--keep-package]',
    implemented: true,
    hasTemplate: false,
    requiresProject: false,
    features: [
  ...
  // ===== SDD: spec-driven development primitives =====
  {
    ...
    features: [
      ...
      'Sub-verbs: list, show, update, apply-delta, validate, set-status, record-review, link-task, ship, audit, inventory',
    ],
  },
  {
    name: 'audit-spec',
  ...
  ...(
    [
      [
        'daemon',
        'Run the prjct daemon in the foreground',
        undefined,
        'start [--foreground|-f] | stop | restart | status | logs [--follow|-f] [--lines=N|-n N]',
      ],
      ['stop', 'Stop the running prjct daemon', undefined, '[--force|-f]'],
      ...
      [
        'hooks',
        'Inspect or reinstall the Claude Code hooks',
        undefined,
      ...
      [
        ...
        undefined,
        '[--verbose|-v] [--debounce=<ms>] [--interval=<sec>]',
      ],
      ['version', 'Print the installed prjct version + provider status'],
      ['prefs', 'Inspect or set workflow preferences'],
      ['retro', 'Summarize what shipped over a time window', undefined, '[window] — 24h, 7d, …'],
    ...
    ([name, description, routing, params]): CommandMeta => ({
      name,
      group: 'setup',
      description,
      routing,
